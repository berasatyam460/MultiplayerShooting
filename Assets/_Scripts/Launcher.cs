...
public class Launcher : MonoBehaviourPunCallbacks
{
    ...
    public static bool hasSetTheNickName;
    ...
    {
        PhotonNetwork.LoadLevel(allMaps[UnityEngine.Random.Range(0,allMaps.Length)]);
    }

    [SerializeField] public string[] allMaps;
    [SerializeField] public bool changeMapinMultipleRounds = true;
